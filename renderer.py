...
@ti.data_oriented
class Renderer:
    def __init__(self, dx, image_res, up, voxel_edges, voxel_scope, exposure=3):
        ...
        self.voxel_grid_res = voxel_scope
    ...
    @ti.func
    def delete_voxel(self, idx):
        self.voxel_material[idx] = ti.cast(0, ti.i8)

    @ti.kernel
    def etch(self, eye_pos: ti.math.vec3, d: ti.math.vec3):
        hit_dist, normal, c, hit_light, idx = self.dda_voxel(eye_pos, d)
        self.delete_voxel(idx)
        print("Etched voxel at", idx, "with material", c)
